<form class=" w-full max-w-lg">
    <div class=" flex items-center pt-10 pb-12 w-full md:w-1/2 px-3 mb-6 md:mb-0 ">
        ...
        <input
            ...
            name="name" id="name" value="{{old('name') ?? $stadium->name ?? ''}}">
        @error('name')
    ...
    <div class="flex items-center pt-10 pb-12 w-full md:w-1/2 px-3 mb-6 md:mb-0 ">
        ...
        <input
            class="appearance-none block w-9/12 bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
            type="number" max="130000" name="capacity" id="capacity"
    ...
    <div class="  pt-10 pb-12 w-full md:w-1/2 px-3 mb-6 md:mb-0 ">
        ...
        <textarea
            class="appearance-none block w-full  bg-gray-200 text-gray-700 border border-red-500 rounded py-10 px-16 mb-12  focus:outline-none focus:bg-white"
            name="body" id="body"> {{old('body') ?? $stadium->body ?? ''}}</textarea>
